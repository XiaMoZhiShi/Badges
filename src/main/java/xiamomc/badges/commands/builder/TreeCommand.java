package xiamomc.badges.commands.builder;
...
public class TreeCommand implements ISubCommand
{
    ...
    @Nullable
    private BiFunction<CommandSender, List<String>, List<String>> onTabComplete;

    @Nullable
    private BiFunction<CommandSender, List<String>, Boolean> executeFunction;

    @NotNull
    private FormattableMessage helpDescription = new FormattableMessage(XiamoBadges.instance(), "Nil");
    ...
    {
        return (this.onTabComplete == null) ? emptyList : this.onTabComplete.apply(source, args);
    ...
    public static class TreeCommandBuilder
    {
        ...
        {
            public String name;
            public BiFunction<CommandSender, List<String>, List<String>> onTabComplete;
            ...
            public TreeCommand toCmd()
            {
                ...
                instance.helpDescription = (this.helpMessage == null)
                        ? new FormattableMessage(XiamoBadges.instance(), "Nil")
                        : this.helpMessage;
        ...
        public TreeCommandBuilder onFilter(BiFunction<CommandSender, List<String>, List<String>> func)
        {
            Objects.requireNonNull(currentMeta, "CurrentMeta is null!");
